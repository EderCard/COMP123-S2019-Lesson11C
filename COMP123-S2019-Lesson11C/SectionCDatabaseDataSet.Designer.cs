...
namespace COMP123_S2019_Lesson11C.SectionCDatabaseDataSetTableAdapters {
    ...
    public partial class StudentTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[StudentTable] WHERE (([Id] = @Original_Id) AND ((@IsNull_StudentId = 1 AND [StudentId] IS NULL) OR ([StudentId] = @Original_StudentId)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[StudentTable] SET [StudentId] = @StudentId, [FirstName] = @FirstName, [LastName] = @LastName WHERE (([Id] = @Original_Id) AND ((@IsNull_StudentId = 1 AND [StudentId] IS NULL) OR ([StudentId] = @Original_StudentId)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)));
